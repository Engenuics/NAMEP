/***********************************************************************************************************************
File: mpg51-ehdw-01.c                                                                

Description:
This file provides board support functions for the nRF51422 processor on the MPG development boards.
***********************************************************************************************************************/
...
void GpioSetup(void)
{
  ...
  NRF_GPIO->PIN_CNF[P0_30_INDEX] = P0_30_CNF;
  NRF_GPIO->PIN_CNF[P0_29_INDEX] = P0_29_CNF;
  NRF_GPIO->PIN_CNF[P0_28_INDEX] = P0_28_CNF;
  NRF_GPIO->PIN_CNF[P0_27_INDEX] = P0_27_CNF;
  NRF_GPIO->PIN_CNF[P0_26_INDEX] = P0_26_CNF;
  NRF_GPIO->PIN_CNF[P0_25_INDEX] = P0_25_CNF;
  NRF_GPIO->PIN_CNF[P0_24_INDEX] = P0_24_CNF;
  NRF_GPIO->PIN_CNF[P0_23_INDEX] = P0_23_CNF;
  NRF_GPIO->PIN_CNF[P0_22_INDEX] = P0_22_CNF;
  NRF_GPIO->PIN_CNF[P0_21_INDEX] = P0_21_CNF;
  NRF_GPIO->PIN_CNF[P0_20_INDEX] = P0_20_CNF;
  NRF_GPIO->PIN_CNF[P0_19_INDEX] = P0_19_ARED_CNF;
  NRF_GPIO->PIN_CNF[P0_18_INDEX] = P0_18_ABLU_CNF;
  NRF_GPIO->PIN_CNF[P0_17_INDEX] = P0_17_AGRN_CNF;
  NRF_GPIO->PIN_CNF[P0_16_INDEX] = P0_16_MBLU_CNF;
  NRF_GPIO->PIN_CNF[P0_15_INDEX] = P0_15_MRED_CNF;
  NRF_GPIO->PIN_CNF[P0_14_INDEX] = P0_14_MGRN_CNF;
  NRF_GPIO->PIN_CNF[P0_13_INDEX] = P0_13_DRED_CNF;
  NRF_GPIO->PIN_CNF[P0_12_INDEX] = P0_12_DBLU_CNF;
  NRF_GPIO->PIN_CNF[P0_11_INDEX] = P0_11_DGRN_CNF;
  NRF_GPIO->PIN_CNF[P0_10_INDEX] = P0_10_YRED_CNF;
  NRF_GPIO->PIN_CNF[P0_09_INDEX] = P0_09_YBLU_CNF;
  NRF_GPIO->PIN_CNF[P0_08_INDEX] = P0_08_YGRN_CNF;
  NRF_GPIO->PIN_CNF[P0_07_INDEX] = P0_07_BUTTON0_CNF;
  NRF_GPIO->PIN_CNF[P0_06_INDEX] = P0_06_BUTTON1_CNF;
  NRF_GPIO->PIN_CNF[P0_05_INDEX] = P0_05_BUTTON2_CNF;
  NRF_GPIO->PIN_CNF[P0_04_INDEX] = P0_04_BUTTON3_CNF;
  NRF_GPIO->PIN_CNF[P0_03_INDEX] = P0_03_CNF;
  NRF_GPIO->PIN_CNF[P0_02_INDEX] = P0_02_CNF;
  NRF_GPIO->PIN_CNF[P0_01_INDEX] = P0_01_CNF;
  NRF_GPIO->PIN_CNF[P0_00_INDEX] = P0_00_CNF;
